# -*- coding: utf-8 -*-
"""[ServiceAgreement]GenerateEmbeddingsandQuery.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1mZGBQ3a8NqpdK5EV4ji_GT9HlK-Jwqcx
...
images = convert_from_path('./master-service-agreement.pdf')
...
idx = get_results("What is Per Hour Rate of Business Analyst")[0]
print(idx)
im = images[idx]
...
batch_queries = processor.process_queries(["What is Per Hour Rate of Business Analyst"]).to(model.device)
...
answer, top_k = get_answer_local("What is Day Rate of Business Analyst")
